...
class View(Tk):
    ...
    def create_all_buttons(self):
        self.btn_students = Button(self.frame_top, text="Students", command=self.controller.open_file)
        self.btn_students.grid(row=0, column=0, padx=5, pady=2, sticky=EW)

        self.btn_tasks = Button(self.frame_top, text="Tasks")
        self.btn_tasks.grid(row=1, column=0, padx=5, pady=2, sticky=EW)


        self.btn_mix = Button(self.frame_top, text="Mix")
        self.btn_mix.grid(row=0, column=2, padx=5, pady=2, sticky=EW)


        self.btn_save = Button(self.frame_top, text="Save")
